...
```rm -rf test```                                                                      (Remove directory forcefully)  
                                                                                       -r → recursive  
                                                                                       -f → force (no prompt)
...
```tail -f file.txt```                                                                  (Show last lines and follow live updates)  
                                                                                       -f → follow (real-time)
...
```kill -9 PID```                                                                       (Terminate process forcefully)  
                                                                                       -9 → SIGKILL
...
```watch -n 1 "df -h"```                                                                 (Run command every 1 second, monitor disk usage in real-time)  
